...
<head>
    ...
    <link rel="stylesheet" href="{{asset('front-assets')}}/vendor/fonts/tabler-icons.css" />
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="{{asset('front-assets')}}/vendor/libs/@form-validation/umd/styles/index.min.css" />
                    ...
                    <svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path
                          ...
                          fill="#7367F0" />
                            ...
                            <span class="app-brand-text demo text-body fw-bold ms-1">Gym</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    @livewire('admin.auth.register-component')
                </div>
            </div>
            <!-- /Register -->
        </div>
...
<!-- Vendors JS -->
<script src="{{asset('front-assets')}}/vendor/libs/@form-validation/umd/bundle/popular.min.js"></script>
<script src="{{asset('front-assets')}}/vendor/libs/@form-validation/umd/plugin-bootstrap5/index.min.js"></script>
<script src="{{asset('front-assets')}}/vendor/libs/@form-validation/umd/plugin-auto-focus/index.min.js"></script>

<!-- Main JS -->
<script src="{{asset('front-assets')}}/js/main.js"></script>

<!-- Page JS -->
<script src="{{asset('front-assets')}}/js/pages-auth.js"></script>
</body>
</html>
